...
#define CONFIG_ESP_LCD_TOUCH_MAX_POINTS     1//(ESP_PANEL_DRIVERS_TOUCH_MAX_POINTS)
#define CONFIG_ESP_LCD_TOUCH_MAX_BUTTONS    0//(ESP_PANEL_DRIVERS_TOUCH_MAX_BUTTONS)
