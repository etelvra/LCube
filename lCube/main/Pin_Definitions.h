...
#define I2C_TP_PORT                     (I2C_NUM_1)
#define IOPIN_TP_SCL                    (GPIO_NUM_6)
#define IOPIN_TP_SDA                    (GPIO_NUM_5)
//QSPI  (4-bit) Quad SPI
...
//AMOLED
#define IOPIN_TP_IRQ                    (GPIO_NUM_3)
#define IOPIN_TP_RST                    (GPIO_NUM_4)
#define IOPIN_LCD_RST                   (GPIO_NUM_8)
#define IOPIN_LCD_TE                    (GPIO_NUM_7)

//ADC
#define IOPIN_ADC_MIC                   (GPIO_NUM_1)
//PMIC AXP2101
#define IOPIN_PMIC_PWR                  (GPIO_NUM_2)
#define IOPIN_PMIC_IRQ                  (GPIO_NUM_21)
#define IOPIN_BMI2_INT1                 (GPIO_NUM_39)
